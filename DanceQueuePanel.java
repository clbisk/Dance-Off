...
public class DanceQueuePanel extends JPanel {
	...
	/** getter for the number of arrows in the array */
	...
	private class Listener implements ActionListener {
		...
		public void	actionPerformed(ActionEvent e) {
			...
			if ((Danceoff.getSong() == -1 && songTime < 71000) || (Danceoff.getSong() == 0 && songTime < 87000) || (Danceoff.getSong() == 1 && songTime < 71000) || (Danceoff.getSong() == 2 && songTime < 70000)) {
				//63000, 90000, 70000 
				//clears	buffer
