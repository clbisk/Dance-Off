...
/**contains main function and other functions facilitating the transitioning of screens*/
   ...
   /**
   	...
   	choice panel; song A being represented by -1, song B being represented
   	by 0, and song C being represented by 1
   */
   ...
   */
   ...
   /**displays difficulty selection panel*/
      ...
      //accesses song selection screen layout from DifficultySelectionScreen class
   ...
   /**displays panel for game play after selections are complete*/
      ...
      //accesses layout from GamePlayPanel class
         frame.setContentPane(new DanceQueuePanel());
         frame.setVisible(true);
      }
   }